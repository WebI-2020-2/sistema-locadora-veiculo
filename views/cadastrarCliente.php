       ...
       <nav class="nav nav-pills nav-justified ">
        ...
        <form class='form' action="./cadastrarCliente.php" method="POST">
            ...
            <div class="mb-3"><br>
                ...
                <input type="text" name="telefone"  title="Digite um telefone valido exemplo(xx) xxxxx-xxxx " class="form-control" id="telefone" autocomplete="off" data-mask="(00) 00000-0000" maxlength="15"  required>
