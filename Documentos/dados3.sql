...
--
-- Host: 127.0.0.1
-- Generation Time: 09-Ago-2021 às 20:46
...
(12, 'Luana Sthefany', 'luanacocos33@gmail.com', 'rua 1', '(77) 1212-1212');
...
(8, 4, 6, 3, '2002', 'preto', 'dsadasda', 'disponivel', 'carro1');
...
--
ALTER TABLE `devolucao`
  MODIFY `iddevolucao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `itemaluguel`
  MODIFY `iditemaluguel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `seguro`
  MODIFY `idseguro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
