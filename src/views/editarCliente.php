        ...
        <form class='form' action="./editarCliente.php?id=<?= $cliente->getidcliente() ?>" method="POST">
            ...
            <div class="mb-3 d-flex justify-content-between">
                <div class="input">
                    ...
                    <input type="tel"  \ pattern="^(\([0-9]{2}\))\s([9]{1})?([0-9]{4})-([0-9]{4})$"  \ title="Digite um telefone valido exemplo(xx) xx-xxxx-xxxx "  name="telefone"   value="<?= $cliente->gettelefone() ?>" step="any" name="telefone" class="form-control" id="telefone" required>
                </div>
            </div>
            <div class="button"><br>
