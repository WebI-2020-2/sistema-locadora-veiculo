        ...
        <form class='form' action="./editarCliente.php?id=<?= $cliente->getidcliente() ?>" method="POST">
            ...
            <div class="mb-3 d-flex justify-content-between">
                <div class="input">
                    ...
                    <input type="tel" \ pattern="^(\([0-9]{2}\))\s([9]{1})?([0-9]{4})-([0-9]{4})$"   name="telefone" title="EXEMPLO (00) 00000-0000"  value="<?=$cliente->gettelefone()?>" class="form-control" id="telefone" autocomplete="off" data-mask="(00) 00000-0000" maxlength="15"  required>
                </div>
            </div>
            <div class="button"><br>
