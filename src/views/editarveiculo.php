    ...
    <div class="container">
        ...
        <form class='form' action="./editarveiculo.php?id=<?= $veiculo->getidveiculo() ?>" method="POST">
            ...
            <div class="mb-3"><br> 
                ...
                <input type="text"pattern="[A-Z]{3}[0-9][A-Z][0-9]{2}" title="letra maiúscula,digite uma placa valida exemplo:ABC1D23 " step= any   value="<?= $veiculo->getplaca() ?>" name="placa" class="form-control" id="placa" autocomplete="off" required>
            </div>
            <div class="mb-3"><br>
