...
class VendasController extends aluguel
{
    ...
    public function findAll()
    {
        ...
        foreach ($stm->fetchAll() as $aluguel) {
            array_push(
                $aluguels,
                new aluguel($aluguel->idaluguel, $aluguel->idcliente, $aluguel->total, $aluguel->pago, $aluguel->diaria, $aluguel->desconto, $aluguel->troco, $aluguel->datalocacao, $aluguel->combustivelatual)
            );
        }
        return $aluguels;
    }
