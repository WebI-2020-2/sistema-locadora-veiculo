...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Ago-2021 às 05:32
...
(3, 3, '600', '613', '0', '500', '0', '2021-08-13', '1000');
...
(3, 'luana silva', 'luanacocos22@gmail.com', 'rua seis de agosto', '(77) 9912-1212');
...
(7, 3, 'sem dano', '2021-08-06', '13', '1000');
...
(8, 'halisson souza', '099.121.121-12');
...
(5, 3, 6, 6, '2020', 'verde', 'i9i1e17', 'disponivel', 'carro1');
...
--
ALTER TABLE `aluguel`
  MODIFY `idaluguel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `devolucao`
  MODIFY `iddevolucao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `itemaluguel`
  MODIFY `iditemaluguel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
